...
void ATFloatTester::run(const DynamicContext* context) {
  // test 1 -- equality
  const ATFloatOrDerived::Ptr float1 = context->getItemFactory()->createFloat(10, context);
  const ATFloatOrDerived::Ptr float2 = context->getItemFactory()->createFloat(10.0, context);
  const ATFloatOrDerived::Ptr float3 = context->getItemFactory()->createFloat(X("10"), context);
  const ATFloatOrDerived::Ptr float4 = context->getItemFactory()->createFloat(X("10.0"), context);
  const ATFloatOrDerived::Ptr float5 = context->getItemFactory()->createFloat(X("1.0E+1"), context);
  const ATFloatOrDerived::Ptr float6 = context->getItemFactory()->createFloat(1.0e1, context);
  const ATFloatOrDerived::Ptr float7 = context->getItemFactory()->createFloat(100e-1, context);
  ...
  // test 3 -- inequality
  const ATFloatOrDerived::Ptr float8 = context->getItemFactory()->createFloat(100, context);
  const ATFloatOrDerived::Ptr float9 = context->getItemFactory()->createFloat(-100, context);
  const ATFloatOrDerived::Ptr float10 = context->getItemFactory()->createFloat(X("0.2e+1"), context);
  const ATFloatOrDerived::Ptr float11 = context->getItemFactory()->createFloat(X("0.5e+1"), context);
  const ATFloatOrDerived::Ptr float12 = context->getItemFactory()->createFloat(2.1479, context);
  const ATFloatOrDerived::Ptr float13 = context->getItemFactory()->createFloat(4.5, context);
  const ATFloatOrDerived::Ptr float14 = context->getItemFactory()->createFloat(1, context);
  ...
  const ATFloatOrDerived::Ptr floatNaN = context->getItemFactory()->createFloat(X("NaN"), context);
  const ATFloatOrDerived::Ptr floatINF = context->getItemFactory()->createFloat(X("INF"), context);
  const ATFloatOrDerived::Ptr floatNegINF = context->getItemFactory()->createFloat(X("-INF"), context);
  const ATFloatOrDerived::Ptr floatZero = context->getItemFactory()->createFloat(X("0"), context);
  const ATFloatOrDerived::Ptr floatNegZero = context->getItemFactory()->createFloat(X("-0"), context);
