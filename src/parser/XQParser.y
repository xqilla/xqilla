...
Start_FunctionDecl:
  ...
  {
    QP->_function = WRAP(@1, new (MEMMGR) XQUserFunction($4, $5, $7, $6, $2, true, MEMMGR));
  }
  ;
...
FunctionDecl:
    _DECLARE_ FunctionOptions FunctionKeyword FunctionName FunctionParamList FunctionDeclReturnType EnclosedExpr
  {
    $$ = WRAP(@1, new (MEMMGR) XQUserFunction($4, $5, $7, $6, $2, true, MEMMGR));
  }
  | _DECLARE_ FunctionOptions FunctionKeyword FunctionName FunctionParamList FunctionDeclReturnType _EXTERNAL_
  {
    $$ = WRAP(@1, new (MEMMGR) XQUserFunction($4, $5, 0, $6, $2, true, MEMMGR));
  }
  ;
