 ...
 *      Initial check in.
 *
 *      Revision 1.2  2005/03/04 18:32:47  gmf
 *      AIX build -- add NULLRCP #define to help compiler coerce RefCountPointer types; add initialize/terminate calls to PathanImplementation to fix a bad pointer to Xerces DOMImplementation
 *
 *      Revision 1.1  2004/07/21 09:23:01  jpcs
 *      Initial check in of the Parthenon backup of Pathan.
 *
 *      Revision 1.3  2003/07/04 14:17:27  crioux
 *      Changed the m_apm_to_string function to remove the '+' sign after the 'E', to conform with f&o canonical representation
 *
