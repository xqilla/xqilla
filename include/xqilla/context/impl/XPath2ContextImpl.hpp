...
#ifndef _XPATH2CONTEXTIMPL_HPP
#define _XPATH2CONTEXTIMPL_HPP
...
class PATHAN_EXPORT XPath2ContextImpl : public DynamicContext
{
public:
  XPath2ContextImpl(XERCES_CPP_NAMESPACE_QUALIFIER MemoryManager* memMgr,
                    XERCES_CPP_NAMESPACE_QUALIFIER XMLGrammarPool* xmlgr = 0,
                    XERCES_CPP_NAMESPACE_QUALIFIER DOMNode* contextNode = 0);
  virtual ~XPath2ContextImpl();
  ...
  /** Returns the XPath2MemoryManager* for this context */
  ...
  ////////////////////////////////////////////
  // Pathan context specific helper methods //
  ////////////////////////////////////////////

	/** Get the uri bound to a prefix in the XPathNSResolver */
