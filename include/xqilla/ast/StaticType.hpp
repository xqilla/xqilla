...
public:
  ...
  enum StaticTypeFlags {
    ...
    TYPED_ATOMIC_TYPE        = (NUMERIC_TYPE | ANY_SIMPLE_TYPE | ANY_URI_TYPE | BASE_64_BINARY_TYPE | BOOLEAN_TYPE |
                                DATE_TYPE | DATE_TIME_TYPE | DAY_TIME_DURATION_TYPE | DURATION_TYPE | G_DAY_TYPE |
                                G_MONTH_TYPE | G_MONTH_DAY_TYPE | G_YEAR_TYPE | G_YEAR_MONTH_TYPE | HEX_BINARY_TYPE |
